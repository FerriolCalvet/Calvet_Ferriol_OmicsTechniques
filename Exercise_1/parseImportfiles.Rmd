...
```{r}
setwd("~/Documents/Omics/Practices/PracticesM2/OmicsModule2_practice1")
...
hist(expres[,1], main = "First column")


row_means_apply <- apply(expres,1, mean)

row_means_dataframe <- rowMeans(expres)
